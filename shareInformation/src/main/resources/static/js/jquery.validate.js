...
*/
	...
	messages: {
		...
		rangelength: $.validator.format("请输入{0}到{1}个字符宽的字符。"),
		range: $.validator.format("请输入{0}到{1}之间的值。"),
		max: $.validator.format("请输入比{0}小的值。"),
		min: $.validator.format("请输入比{0}大的值。")
	},
	...
	prototype: {
		...
		showLabel: function( element, message ) {
			...
			if ( label.length ) {
				...
				label.removeClass( this.settings.success ).addClass( this.settings.errorClass );
