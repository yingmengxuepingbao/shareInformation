...
CREATE TABLE `msg_push_activity`  (
  `activity_id`  char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '活动编号',
...
`receiving_way_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '奖励领取方式编号',
...
CREATE TABLE `msg_push_activity_extend_way_veritify_record`  (
  `activity_extend_way_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '推广活动途径编号',
...
CREATE TABLE `msg_push_activity_rule`  (
  `activity_rule_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '活动规则编号',
...
CREATE TABLE `msg_push_extend_way`  (
  `extend_way_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '推广途径编号',
...
CREATE TABLE `msg_push_membership_level`  (
  `membership_level_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '会员等级编号',
...
CREATE TABLE `msg_push_product_base`  (
  `product_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '品类编号',
...
CREATE TABLE `msg_push_resource`  (
  `msg_push_resource_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '资源编号',
...
CREATE TABLE `msg_push_reward_user`  (
  `id` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '主键',
...
CREATE TABLE `msg_push_role`  (
  `msg_push_role_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '角色编号',
...
CREATE TABLE `msg_push_user`  (
  `user_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '用户编号',
