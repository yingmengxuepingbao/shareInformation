...
*/
DROP database IF EXISTS `msg_push`;
...
`receiving_way_id` char(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '奖励领取方式编号',
...
CREATE TABLE `msg_push_activity_rule`  (
  `activity_rule_id` char(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '活动规则编号',
...
CREATE TABLE `msg_push_extend_way`  (
  `extend_way_id` char(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '推广途径编号',
...
CREATE TABLE `msg_push_membership_level`  (
  `membership_level_id` char(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '会员等级编号',
...
CREATE TABLE `msg_push_product_base`  (
  `product_id` char(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '品类编号',
...
CREATE TABLE `msg_push_resource`  (
  `msg_push_resource_id` char(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '资源编号',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新日期',
  `isEnable` tinyint(1) NULL DEFAULT NULL COMMENT '是否禁用',
   PRIMARY KEY (`msg_push_resource_id`)
...
CREATE TABLE `msg_push_role`  (
  `msg_push_role_id` char(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '角色编号',
  `msg_push_role_name` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '角色名称',
  `create_user_id` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建日期',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新日期',
PRIMARY KEY (`msg_push_role_id`)
...
CREATE TABLE `msg_push_user`  (
  `user_id` char(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL  COMMENT '用户编号',
...
INSERT INTO `msg_push_activity` VALUES ('1', '张艺馨卖樱桃1', '1','1', '一斤樱桃','1','2019-5-12', '2019-10-25','2019-5-15 22:28:05', '2019-5-15 22:28:08','1','1','0');
INSERT INTO `msg_push_activity` VALUES ('2', '张艺馨卖樱桃2', '1','1', '10元代金券','1','2019-5-12', '2019-10-25','2019-5-15 22:28:05', '2019-5-15 22:28:08','1','1','0');
INSERT INTO `msg_push_activity` VALUES ('3', '张艺馨卖樱桃3', '1','1', '5元代金券','1','2019-5-12', '2019-10-25','2019-5-15 22:28:05', '2019-5-15 22:28:08','1','1','0');
 

INSERT INTO `msg_push_activity_rule` VALUES('1','转发消息送樱桃','1','1','2019-5-12','2019-10-25','1');
INSERT INTO `msg_push_activity_rule` VALUES('2','转发消息送代金券','1','1','2019-5-12','2019-10-25','1');
INSERT INTO `msg_push_activity_rule` VALUES('3','转发消息送果币','1','1','2019-5-12','2019-10-25','1');
 
 
 INSERT INTO `msg_push_award_receiving_way` VALUES('1','快递发货（快递费自费）','1','2019-5-12','2019-10-25','2019-5-15 22:28:05','2019-5-15 22:28:05');
 INSERT INTO `msg_push_award_receiving_way` VALUES('2','线上发放','1','2019-5-12','2019-10-25','2019-5-15 22:28:05','2019-5-15 22:28:05');
 INSERT INTO `msg_push_award_receiving_way` VALUES('3','线上发放','1','2019-5-12','2019-10-25','2019-5-15 22:28:05','2019-5-15 22:28:05');
